...
$string['prompt:instructions'] = 'Генеришите излаз у потпуности на наведеном језику. Обезбедите да је садржај примерен датом узрасту/разреду ученика, да је усаглашен са локалним курикулумом када је применљиво и да директно подржава наведене циљеве. Структуришите излаз јасно, користећи наслове, поднаслове и набрајања где је прикладно.';
