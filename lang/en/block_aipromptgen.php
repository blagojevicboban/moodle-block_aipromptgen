...
$string['error:apifailed'] = 'AI provider returned an error or unexpected response.';
$string['error:curl'] = 'Failed to contact AI service.';
...
$string['form:selectedexternal'] = 'Selected External AI: {$a}';
$string['form:selectedmodel'] = 'Selected model: {$a}';
$string['form:sendtochatgpt'] = 'Send to AI';
...
$string['missingapikey'] = 'The OpenAI API key is not configured.';
...
$string['setting:ollama_endpoint_desc'] = 'Base URL for the Ollama service (e.g., http://localhost:11434).';
$string['setting:ollama_model'] = 'Ollama model';
$string['setting:ollama_model_desc'] = 'Model name pulled in your Ollama daemon (e.g., llama3, mistral).';
$string['setting:ollama_stream'] = 'Enable Ollama streaming';
$string['setting:ollama_stream_desc'] = 'Send requests with streaming enabled and display partial responses as they arrive.';
$string['setting:coreai_method'] = 'Core AI method override';
$string['setting:coreai_method_desc'] = 'Optional method name on the core AI manager to call (leave blank to auto-detect: complete/chat_complete/generate/...).';
$string['setting:provider'] = 'AI provider';
$string['setting:provider_desc'] = 'Select which AI provider to use for generating responses.';
$string['setting:provider_ollama'] = 'Ollama (self-hosted)';
